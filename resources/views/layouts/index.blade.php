        ...
        <div class="container">
            ...
            <div id="navbarcollapse" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a href="{{url('/')}}" class="nav-link active ">首页</a>
                    </li>
                    <li class="nav-item"><a href="{{url('/list')}}" class="nav-link ">博客</a>
                    </li>
                    <li class="nav-item"><a href="#" class="nav-link ">发布</a>
                    </li>
