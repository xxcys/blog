            ...
            <div class="layui-row">
                <form class="layui-form" action="{{url('admin/article')}}" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="art_title" name="art_title" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">
                            <span class="x-red">*</span>发布人：</label>
                        <div class="layui-input-inline">
                            <input type="text" id="art_editor" name="art_editor"  autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">
                            <span class="x-red">*</span>缩略图:</label>
                        <div class="layui-input-inline">
                            <input type="text" id="art_thumb" name="art_thumb" size="50" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <img src="" alt="" id="art_thumb_img" width="100%" height="100%">
                            <br>
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea placeholder="请输入内容" id="desc" name="art_keywords" class="" rows="5" cols="100"></textarea>
                        </div>
                    <div class="layui-form-item layui-form-text">
                        <label for="desc" class="layui-form-label">文章描述:</label>
                        <div class="layui-input-block">
                            <textarea placeholder="请输入内容" id="desc" name="art_description" class="" rows="5" cols="100"></textarea>
                        </div>
                     <div class="layui-form-item layui-form-text">
